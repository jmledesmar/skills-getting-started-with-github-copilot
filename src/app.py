...
activities = {
    ...
    "Soccer Team": {
        "description": "Outdoor soccer practice and weekend league matches",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "rachel@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training, technique workshops, and friendly meets",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, sculpture, and mixed media art projects",
